...
For directory prospecting specifically, the [directory backlink opportunity finder](/free-tools/directory-backlink-opportunity-finder) can surface relevant directories for your niche without manual searching.
...
Community platforms are common sources of unlinked mentions. For platform-specific playbooks, see [how to get backlinks from Reddit](/backlinks-from/reddit) and [how to get backlinks from Quora](/backlinks-from/quora). For editorial mentions from news publications, see [how to get backlinks from news websites](/backlinks-from/news-websites). For authoritative editorial citations that compound over time, see [how to get backlinks from Wikipedia](/backlinks-from/wikipedia).
