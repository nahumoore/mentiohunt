...
- **Reddit video/image/post downloader** — 33k+/mo but consumer ICP, zero conversion
- **Discord server finder** — 6,600/mo but KD 49, 263 RDs, gaming audience
- **Facebook group finder** — easy KD but navigational intent, searchers want Facebook's own search
- **Free backlink checker** — KD 81, 16k+ RDs, Ahrefs/Moz wall
- **Free social listening tool** — 720/mo KD 16 but content page not tool, moved to pseo-strategy.md
