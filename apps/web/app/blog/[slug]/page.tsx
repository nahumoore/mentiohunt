...
export async function generateStaticParams() {
  return getResourceSlugs("articles").map((slug) => ({ slug }))
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: "article",
      url: `https://mentiohunt.com/blog/${post.meta.slug}`,
...
export default async function BlogArticlePage({ params }: Props) {
  ...
  const articleSchema = {
    ...
    url: `https://mentiohunt.com/blog/${meta.slug}`,
        ...
        <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid gap-10 xl:grid-cols-[minmax(0,740px)_360px] xl:items-start xl:justify-between xl:gap-16">
            <article className="text-foreground lg:max-w-[740px]">
              <SummarizeWithAI url={`https://mentiohunt.com/blog/${meta.slug}`} />
