...
Unlinked mentions also matter because search is becoming more brand-aware. The research file notes that [mentions and expert citations are increasingly discussed in the context of AI search visibility](https://www.buzzstream.com/blog/link-building-statistics/). That does not mean every mention will improve rankings or AI visibility. But it does mean founders should pay attention to where their brand is being discussed, even when the link is not there yet. The same attention matters for AI-generated answers — ChatGPT and similar tools cite sources based on trust signals that closely mirror the ones that produce unlinked mentions. For a focused playbook on that surface, see [how to get backlinks from ChatGPT](/backlinks-from/chatgpt).
...
Expert quote platforms and journalist request communities can also be useful. The key is to respond with a specific point of view, not generic commentary. Your quote should sound like it came from someone who has done the work. For a full Digital PR playbook covering data campaigns, journalist sourcing, and newsjacking, see [how to get backlinks from news websites](/backlinks-from/news-websites).
