            ...
            <div className="space-y-4">
              {!hasResults ? (
                ...
                <>
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold transition-colors ${
                          selectedCompetitor?.id === competitor.id
                            ? "border-[var(--color-blaze-orange)]/40 bg-[var(--color-blaze-orange)]/10 text-[var(--color-princeton-orange)]"
                            : "border-border bg-card text-muted-foreground hover:border-[var(--color-blaze-orange)]/25 hover:text-foreground"
                        }`}
                      >
                        <span
                          aria-hidden="true"
                          className="size-4 rounded bg-contain bg-center bg-no-repeat"
                          style={{
                            backgroundImage: `url(${getFaviconUrl(competitor.domain)})`,
                          }}
                        />
                        {competitor.name}
                        <span className="rounded-full bg-[var(--color-blaze-orange)]/10 px-1.5 py-0.5 text-[0.6rem] font-bold text-[var(--color-princeton-orange)]">
                          {competitor.gapCount}
                        </span>
                      </button>
                    ))}
                  ...
                  {selectedCompetitor ? (
                    <div className="rounded-[1.75rem] border border-[var(--color-blaze-orange)]/20 bg-card p-5 sm:p-6">
                      <div className="flex items-center gap-4">
                        <div className="flex size-12 shrink-0 items-center justify-center rounded-[1.15rem] border border-border bg-background shadow-sm">
                          <span
                            ...
                            style={{
                              backgroundImage: `url(${getFaviconUrl(selectedCompetitor.domain)})`,
                            }}
                          />
                        </div>
                        ...
                        <div className="text-right">
                          <p className="font-heading text-2xl font-semibold tracking-[-0.045em] text-[var(--color-princeton-orange)]">
                            {selectedCompetitor.gapCount}
                          </p>
