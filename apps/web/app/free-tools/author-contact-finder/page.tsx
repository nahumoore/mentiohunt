...
import { AuthorContactFinder } from "./tool"
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/free-tools/author-contact-finder",
  },
  openGraph: {
    title: "Author Contact Finder - Free Tool",
    description:
...
export default async function AuthorContactFinderPage() {
  const post = getPostBySlug("author-contact-finder", "free-tools")
  ...
  const toolSchema = {
    ...
    description:
      "Paste a blog post URL and find the author's name, role, and most likely contact email for backlink outreach.",
    url: "https://mentiohunt.com/free-tools/author-contact-finder",
    publisher: {
      "@type": "Organization",
      name: "Mentiohunt",
    ...
    featureList: [
      "Author name and role detection from a byline",
      "Likely email with a clear confidence label",
      "Fallback general contact when no direct email exists",
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <RelatedFreeTools currentSlug={FREE_TOOL_NAMES.authorContactFinder} />
