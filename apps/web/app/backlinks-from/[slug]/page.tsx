...
export default async function BacklinksFromArticlePage({ params }: Props) {
  ...
  const relatedGuides = getRelatedWithFallback(slug, "backlinks-from")
      ...
      <main className="flex-1">
        ...
        <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
          ...
          <RelatedResourcesSection
            ...
            heading="More platform guides worth opening next."
            description="Jump to the adjacent surfaces where this same article could create fit, context, or a cleaner outreach angle."
            items={relatedGuides}
            basePath="/backlinks-from"
            browseAllHref="/backlinks-from"
            browseAllLabel="Browse all platform guides"
            getItemIcon={getPlatformCardIcon}
          />
        </div>
      </main>
