 ...
 *   website_authority, traffic_overview, ai_visibility, website_details,
 *   keyword_ideas, keyword_difficulty, keyword_metrics, keyword_rank,
 *   serp_overview, top_websites
 */
