...
import { BrokenLinkFinder } from "./tool"
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/free-tools/broken-link-finder",
  },
  openGraph: {
    title: "Broken Link Finder - Free Tool",
    description:
...
export default async function BrokenLinkFinderPage() {
  const post = getPostBySlug("broken-link-finder", "free-tools")
  ...
  const toolSchema = {
    ...
    description:
      "Enter your website URL and find real pages in your niche with dead outbound links, ready to pitch as broken-link replacements.",
    url: "https://mentiohunt.com/free-tools/broken-link-finder",
    publisher: {
      "@type": "Organization",
      name: "Mentiohunt",
    ...
    featureList: [
      "Niche-relevant resource page discovery",
      "Live outbound link status checks",
      "Confirmed dead link reporting, not guesses",
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <RelatedFreeTools currentSlug={FREE_TOOL_NAMES.brokenLinkFinder} />
