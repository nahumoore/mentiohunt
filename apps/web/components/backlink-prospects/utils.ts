...
export const DOMAIN_RATING_COLOR_SCHEMES = {
  ...
  low: {
    ...
    accent: "#dc2626",
    track: "#fca5a5",
    center: "linear-gradient(180deg, rgba(254,242,242,0.98) 0%, rgba(254,226,226,0.92) 100%)",
  ...
  medium: {
    ...
    track: "#fdba74",
    center: "linear-gradient(180deg, rgba(255,247,237,0.98) 0%, rgba(255,237,213,0.92) 100%)",
  ...
  high: {
    ...
    accent: "#16a34a",
    track: "#86efac",
    center: "linear-gradient(180deg, rgba(240,253,244,0.98) 0%, rgba(220,252,231,0.92) 100%)",
