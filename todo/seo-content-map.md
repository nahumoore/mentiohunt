...
**Phase 2 — widen the cluster:**
6. `/blog/free-social-listening-tools` — 720, KD 11.
7. `/blog/reddit-for-business` — 880, KD 27.
8. `/blog/reddit-marketing-tools` — KD 8.
9. `/blog/how-to-promote-on-reddit` — KD 11.
10. `/blog/unlinked-brand-mentions` — KD 3 (bridge back toward backlink engine).

**Phase 3 — scale + adjacent platforms:**
11. Programmatic `/best-subreddits-for/[niche]` (founder niches first).
12. New monitoring landing pages by volume × fit: `social-media-monitoring` (1000, KD16), `tiktok-monitoring` (140), `telegram-monitoring` (140), `youtube-monitoring` (70).
13. Reddit-monitoring competitor comparisons (alternative-articles.md).
