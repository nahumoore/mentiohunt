...
[Unlinked mentions](/blog/unlinked-brand-mentions) also matter because search is becoming more brand-aware. One widely cited analysis of tens of thousands of brands found that unlinked mentions correlate with AI Overview visibility roughly three times more strongly than backlinks do. That does not mean every mention will improve rankings or AI visibility. But it does mean founders should pay attention to where their brand is being discussed, even when the link is not there yet. The same attention matters for AI-generated answers — ChatGPT and similar tools cite sources based on trust signals that closely mirror the ones that produce unlinked mentions. For a focused playbook on that surface, see [how to get backlinks from ChatGPT](/backlinks-from/chatgpt).
