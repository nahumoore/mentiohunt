...
const STATUS_OPTIONS = STATUS_FILTERS.filter(
  (
    filter
  ): filter is { value: ProspectStatus; label: string; icon: ElementType } =>
    filter.value !== "all"
)
...
export default function ProspectsPage() {
  ...
  const [actionFilter, setActionFilter] = useState<ProspectActionType | "all">(
    "all"
  )
  ...
  function toggleSort(nextKey: SortKey) {
    ...
    setSortKey(nextKey)
    setSortDirection(
      nextKey === "domain" || nextKey === "type" || nextKey === "status"
        ? "asc"
        : "desc"
    )
  }
                ...
                <tr className="border-b border-border/60">
                  ...
                  <th className="px-2 py-3 text-left text-xs font-medium text-muted-foreground">
                    <ColumnHeader
                      ...
                      sortable
                      sortDirection={
                        sortKey === "domain" ? sortDirection : null
                      }
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground">
                    <ColumnHeader
                      ...
                      sortable
                      sortDirection={
                        sortKey === "discovered_at" ? sortDirection : null
                      }
