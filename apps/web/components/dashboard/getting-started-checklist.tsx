...
export function GettingStartedChecklist() {
  ...
  const items: ChecklistItem[] = [
    ...
    },
    {
      ...
      text: "So replies land with you and you can answer personally.",
      done: hasActiveEmailAccount === true,
    },
  ]
  ...
  return (
    <Card className="mb-6 rounded-xl border border-border px-5 py-4 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-0.5 text-xs text-muted-foreground">
            Discovery and outreach already run on their own. These four make the
            results better.
          </p>
        </div>
