                          ...
                          <div className="flex min-w-0 gap-4">
                            ...
                            <div className="min-w-0">
                              <div className="flex flex-wrap items-center gap-2">
                                ...
                                <span className="rounded-full border border-[var(--color-blaze-orange)]/20 bg-[var(--color-blaze-orange)]/8 px-2.5 py-1 text-[0.65rem] font-semibold uppercase text-[var(--color-princeton-orange)]">
                                  Not applied
                                </span>
                              </div>
                              <p className="mt-1 text-sm text-muted-foreground">
      ...
      <section className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div className="container mx-auto max-w-6xl">
          <AutomationCta
            ...
            heading="Turn directory checks into a recurring backlink queue."
            body="Mentiohunt is built to keep surfacing backlink opportunities from your product, competitors, keywords, and content so you always know what to apply for or pitch next."
          />
        </div>
      </section>
    </>
